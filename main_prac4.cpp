...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glLoadIdentity();
		...
		glTranslatef(3.0f, 0.0f, 0.0f); //MORADO
		...
		glRotatef(90, 0.0f, 1.0f, 0.0f); //ROSA
		glScalef(3.0f, 3.0f, 3.0f);
		prisma();
		...
		glRotatef(180, 0.0f, 1.0f, 0.0f); //VERDE
		glScalef(3.0f, 3.0f, 3.0f);
		prisma();
		...
		glRotatef(270, 0.0f, 1.0f, 0.0f); //AMARILLO
		...
		glRotatef(0, 0.0f, 0.0f, 0.0f); //ROJO
		glScalef(2.0f, 2.0f, 2.0f);
		prisma();
		...
		glRotatef(90, 1.0f, 0.0f, 0.0f); //AZUL
...
void arrow_keys ( int a_keys, int x, int y )  // Funcion para manejo de teclas especiales (arrow keys)
{
  switch ( a_keys ) {
    case GLUT_KEY_UP:
		angX += 3.0f;		// Presionamos tecla ARRIBA...
		break;
    case GLUT_KEY_DOWN:
		angX -= 3.0f;		// Presionamos tecla ABAJO...
		break;
	case GLUT_KEY_LEFT:
		angY += 3.0f;
		break;
